...
export function EngagementChart() {
  const data = {
    ...
    datasets: [
      ...
      {
        label:           'Facebook',
        data:            [800, 1200, 900, 1100, 1400, 1300],
        borderColor:     '#1877F2',
      ...
      {
        label:           'TikTok',
        data:            [400, 700, 1200, 1800, 2200, 3100],
        borderColor:     '#010101',
...
export function PlatformMixChart({ data: raw }: { data?: Record<string, number> }) {
  ...
  const labels   = Object.keys(resolved);
  ...
  const data = {
    ...
    datasets: [{
      data:            values,
      backgroundColor: ['#E1306C', '#1877F2', '#010101', '#0A66C2', '#FF0000', '#E60023'],
      borderWidth:     2,
      borderColor:     '#fff',
    }],
  };
      ...
      <Bar
        ...
        options={{
          ...
          scales: {
            ...
            y: { grid: { color: '#f3f4f6' }, stacked: false },
          },
        }}
      />
    </div>
